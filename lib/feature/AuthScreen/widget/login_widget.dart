...
import 'package:maen/feature/AuthScreen/view/forget_password_view.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Get.to(ForgetPasswordView(),transition: Transition.cupertinoDialog,duration: Duration(seconds: 1));
                          },
                          child: const Text(
                            'نسيت كلمة المرور؟',
